...
const AppsCollection = [
    ...
    {index: 2, src: CorpoApp, text: 'CorpoApp to jeden z wielu projektów, które wykonałem w trakcie studiów, którego celem była nauka frameworka React. Projekt ten był wzorowany na produkcie, który firma prowadzącego zajęcia wykładowcy realnie wypuściła na rynek i spieniężyła. Podczas tworzenia aplikacji poznałem nie tylko Reacta, ale także Redux, TypeScript, Styled-Comonents oraz wiele przydatnych blibliotek wspomnianego wcześniej frameworka.', langList: [React_logo, Redux_logo, TS_logo, StyledComponents_logo], githubLink:'https://github.com/Radek25/ReactApp', liveLink:'https://radek25.github.io/ReactApp/'},
    {index: 3, src: WeatherApp, text: 'WeatherApp to prosta aplikacja pozwalająca sprawdzić aktualną pogodę w danym miejscu na świecie. Tworząc ten projekt nauczyłem się pobierać i wykorzystywać dane z zewnętrznego API, a także używać własność localStorage.', langList: [HTML_logo, CSS_logo, JS_logo], githubLink:'https://github.com/Radek25/WeatherApplication', liveLink:'https://radek25.github.io/WeatherApplication/'},
